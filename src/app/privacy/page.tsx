...
export const metadata: Metadata = {
  title: "Termo de Privacidade | reflectify",
  description: "Termo de Privacidade",
};
        ...
        <div className="grid grid-cols-12 m-6 gap-6">
          ...
          <div className="col-span-9 flex flex-col gap-4 text-justify">
            ...
            <p>
              ...
              reflectify respeitar a sua privacidade em relação a qualquer
              informação sua que possamos coletar no site{" "}
              <Link
                href="https://reflectify.com.br/"
                target="_blank"
                rel="noopener"
              >
                reflectify
            ...
            <p>
              ...
              traz garantias de privacidade, confidencialidade, retenção,
            ...
            <p>
              ...
              danos de terceiros. Esteja ciente de que não temos controle sobre
              o conteúdo e práticas de sites de terceiros e não podemos aceitar
            ...
            <p>
              ...
              reflectify, independente de aviso ou notificação. Em caso de
              alteração, as modificações produzem todos os efeitos a partir do
              momento da disponibilização no site.{" "}
            </p>

            <p>
              O site reflectify não se responsabiliza caso você venha utilizar
              seus dados de forma incorreta ou inverídica, ficando excluído de
              qualquer responsabilidade neste sentido.
            </p>

            <strong className="text-lg">Compromisso do Usuário</strong>

            <p>
              O usuário se compromete a fazer uso adequado dos conteúdos e da
              informação que o site reflectify oferece e com caráter
            ...
            <ul>
              ...
              <li>
                ...
                (softwares) do site reflectify, de seus fornecedores ou
            ...
            <strong className="text-xl">Direitos do titular de dados</strong>
            <p>
              O titular de dados pessoais possui o direito de solicitar do site
              reflectify, através do canal específico de tratamento, a qualquer
              momento, mediante requisição formal, informações referentes aos
              seus dados.
            </p>
            <p>
            ...
            <strong className="text-lg">Mais informações</strong>
            <p>
            ...
            <p>
              O site reflectify empregará esforços para resguardar as
              ...
              eletrônicos plenamente eficaz e seguro, o site reflectify não pode
              assegurar que terceiros não autorizados não logrem êxito no acesso
              indevido, eximindo-se de qualquer responsabilidade por danos e
              ...
              técnicos, assim como operacionais resultante da utilização do site
              e em razão de falhas de conexão.
            </p>
          </div>
        </div>
      </div>
